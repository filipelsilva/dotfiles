  ...
  homeConfig =
    { config, ... }:
    {
      home.file = {
        ...
        ".config/i3".source =
          config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/dotfiles/dotfiles/desktop/i3/.config/i3";
        ...
        ".Xresources".source =
          config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/dotfiles/dotfiles/desktop/xresources/.Xresources";
      };
    };
}
