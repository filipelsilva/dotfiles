...
in
{
  ...
  homeConfig =
    { config, ... }:
    {
      home.file = {
        ".lesskey".source =
          config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/dotfiles/dotfiles/headless/less/.lesskey";

        ".vim".source =
          config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/dotfiles/dotfiles/headless/vim/.vim";
      }
      // lib.attrsets.optionalAttrs (!headless) {
        ".config/nvim/init.lua".source =
          config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/dotfiles/dotfiles/headless/nvim/.config/nvim/init.lua";
        ".config/nvim/nvim-pack-lock.json".source =
          config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/dotfiles/dotfiles/headless/nvim/.config/nvim/nvim-pack-lock.json";
        ".config/nvim/lua".source =
          config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/dotfiles/dotfiles/headless/nvim/.config/nvim/lua";
        ".config/nvim/plugin".source =
          config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/dotfiles/dotfiles/headless/nvim/.config/nvim/plugin";
